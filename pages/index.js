...
* 
*  Name: Mohammad Rashidi Khorsand  Student ID: 134713213 Date: 2023/02/13
*
*
********************************************************************************/ 
...
export default function Home() {
  ...
  const { data, error } = useSWR(`https://shy-sandals-eel.cyclic.app/api/movies?page=${page}&perPage=10`);
